...
private: 
    ...
    // 0 Grunt_walk 1 Grunt_leavestair 2 Grunt_run 3 Grunt_turn 4 Grunt_enterstair 5 Grunt_hurtground 6 Grunt_idle 7 Grunt_attack 8 Grunt_hurtground
    int         m_AnimNum;
    float       m_RewindTime;
    bool        m_bRewind;

    vector<int>   m_vecNextAnim;                                 // 애니메이션 별로 다음 애니메이션을 저장. 비반복 애니메이션에만 적용. 반복 애니메이션은 -1
    list<MonsterGruntRewindData> m_MonsterRewindDataList;       // Rewind를 위한 데이터
