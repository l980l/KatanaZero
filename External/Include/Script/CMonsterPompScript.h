...
private:
    ...
    // 0 Pomp_walk 1 Pomp_leavestair 2 Pomp_run 3 Pomp_turn 4 Pomp_knockdown 5 Pomp_hurtground 6 Pomp_idle 7 Pomp_attack 8 Pomp_hurtground
    int         m_AnimNum;
    float       m_RewindTime;
    bool        m_bRewind;

    vector<int>   m_vecNextAnim;                                 // 애니메이션 별로 다음 애니메이션을 저장. 비반복 애니메이션에만 적용. 반복 애니메이션은 -1
    list<MonsterPompRewindData> m_MonsterRewindDataList;       // Rewind를 위한 데이터
