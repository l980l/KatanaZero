...
void CResMgr::CreateDefaultGraphicsShader()
{
	...
	// ======================================
	pShader = new CGraphicsShader;
	pShader->SetKey(L"UI2DLightShader");
	pShader->CreateVertexShader(L"shader\\std2d.fx", "VS_Std2DLight");
	pShader->CreatePixelShader(L"shader\\std2d.fx", "PS_Std2DLight");
	...
	// ============================
	pShader = new CGraphicsShader;
	pShader->SetKey(L"XDistortionShader");
	pShader->CreateVertexShader(L"shader\\postprocess.fx", "VS_XDistortion");
	pShader->CreatePixelShader(L"shader\\postprocess.fx", "PS_XDistortion");
	pShader->SetRSType(RS_TYPE::CULL_NONE);
	pShader->SetDSType(DS_TYPE::NO_TEST_NO_WRITE);
	pShader->SetDomain(SHADER_DOMAIN::DOMAIN_POSTPROCESS);
	AddRes(pShader->GetKey(), pShader);
	...
	// ============================
	pShader = new CGraphicsShader;
	pShader->SetKey(L"PurpleShader");
	pShader->CreateVertexShader(L"shader\\postprocess.fx", "VS_Purple");
	pShader->CreatePixelShader(L"shader\\postprocess.fx", "PS_Purple");
	pShader->SetRSType(RS_TYPE::CULL_NONE);
	pShader->SetDSType(DS_TYPE::NO_TEST_NO_WRITE);
	pShader->SetDomain(SHADER_DOMAIN::DOMAIN_POSTPROCESS);
	AddRes(pShader->GetKey(), pShader);
	...
	// ============================
	pShader = new CGraphicsShader;
	pShader->SetKey(L"DarkShader");
	pShader->CreateVertexShader(L"shader\\postprocess.fx", "VS_Dark");
	pShader->CreatePixelShader(L"shader\\postprocess.fx", "PS_Dark");
	pShader->SetRSType(RS_TYPE::CULL_NONE);
	pShader->SetDSType(DS_TYPE::NO_TEST_NO_WRITE);
	pShader->SetDomain(SHADER_DOMAIN::DOMAIN_POSTPROCESS);
	AddRes(pShader->GetKey(), pShader);
	...
	// ============================
	pShader = new CGraphicsShader;
	pShader->SetKey(L"GridShader");
	pShader->CreateVertexShader(L"shader\\postprocess.fx", "VS_Grid");
	pShader->CreatePixelShader(L"shader\\postprocess.fx", "PS_Grid");
	pShader->SetRSType(RS_TYPE::CULL_NONE);
	pShader->SetDSType(DS_TYPE::NO_TEST_NO_WRITE);
	pShader->SetDomain(SHADER_DOMAIN::DOMAIN_POSTPROCESS);
	AddRes(pShader->GetKey(), pShader);
...
void CResMgr::CreateDefaultMaterial()
{
	...
	// UI2DLightShader Material
	pMtrl = new CMaterial(true);
	pMtrl->SetShader(FindRes<CGraphicsShader>(L"UI2DLightShader"));
	AddRes(L"UI2DAnimLightMtrl", pMtrl);
	...
	// DistortionShader(PostProcess)
	pMtrl = new CMaterial(true);
	pMtrl->SetShader(FindRes<CGraphicsShader>(L"XDistortionShader"));
	AddRes(L"XDistortionMtrl", pMtrl);

	// PurpleShader(PostProcess)
	pMtrl = new CMaterial(true);
	pMtrl->SetShader(FindRes<CGraphicsShader>(L"PurpleShader"));
	AddRes(L"PurpleMtrl", pMtrl);

	// DarkShader(PostProcess)
	pMtrl = new CMaterial(true);
	pMtrl->SetShader(FindRes<CGraphicsShader>(L"DarkShader"));
	AddRes(L"DarkMtrl", pMtrl);
