            ...
            while (0 < SpawnCount)
            {
                ...
                {   
                    ...
                    if (ModuleData.AddVelocity)
                    {
                        ...
                        {
                            float3 vVelocity = { cos((ModuleData.OffsetAngle / 180.f) * 3.1415926535f), sin((ModuleData.OffsetAngle / 180.f) * 3.1415926535f), 0.f };
                            particle.vVelocity.xyz = normalize(vVelocity) * ModuleData.Speed;
                        }
                    }                    
