    ...
    , m_pEditorCam(nullptr)
{
    ...
    CResMgr::GetInst()->FindRes<CMaterial>(L"XDistortionMtrl")->SetTexParam(TEX_0, m_RTCopyTex);
    CResMgr::GetInst()->FindRes<CMaterial>(L"PurpleMtrl")->SetTexParam(TEX_0, m_RTCopyTex);
    CResMgr::GetInst()->FindRes<CMaterial>(L"DarkMtrl")->SetTexParam(TEX_0, m_RTCopyTex);
    CResMgr::GetInst()->FindRes<CMaterial>(L"GridMtrl")->SetTexParam(TEX_0, m_RTCopyTex);
}
