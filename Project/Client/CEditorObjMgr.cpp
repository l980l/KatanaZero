...
void CEditorObjMgr::init()
{
	...
	m_DebugShape[(UINT)SHAPE_TYPE::LINE]->MeshRender()->SetMesh(CResMgr::GetInst()->FindRes<CMesh>(L"LineMesh_Debug"));
	m_DebugShape[(UINT)SHAPE_TYPE::LINE]->MeshRender()->SetMaterial(CResMgr::GetInst()->FindRes<CMaterial>(L"DebugShapeMtrl"));
